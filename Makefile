artifact_name       := item-group-workflow-api
version             := "unversioned"
...
dependency-check:
	...
	DEPENDENCY_CHECK_SUPPRESSIONS_HOME="$${suppressions_home}" "$${suppressions_home}/scripts/depcheck" --repo-name=item-group-workflow-api
